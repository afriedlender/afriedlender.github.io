...
{% include temperature_variation_plot_2.html %}

## Notes to peers

I still need to add comments to most of the second half of the assignment. 

For the last figure, I think my approach might be a bit off. The plot should ressemble the figure in this <a href="https://www.nytimes.com/2020/04/23/learning/whats-going-on-in-this-graph-global-temperature-change.html"> article</a>.
I think this has to do with the fact that I'm using the temperature averages for a single year as opposed to a large date range. How can I determine what is a good baseline global temperature average to which I should compare the yearly variation? 